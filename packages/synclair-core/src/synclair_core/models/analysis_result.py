"""
synclair_core.models.analysis_result
--------------------------------------
...
synclair-reporting and synclair-gui can consume any result without ever
...
class AnalysisResult(BaseModel):
    ...
    config: dict[str, Any] = Field(
        ...
        "config used to produce this result. Kept untyped so synclair-core "
