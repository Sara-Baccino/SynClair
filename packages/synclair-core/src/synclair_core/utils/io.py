...
This lives in synclair-core (not synclair-reporting) because
...
on a downstream package. synclair-reporting builds PDF/HTML/Word report
...
from synclair_core.models.analysis_result import (
    AnalysisResult,
    Figure,
    FigureFormat,
    LogEntry,
...
class ResultPersistenceError(SynClairError):
