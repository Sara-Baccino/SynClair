"""
synclair_core.pipeline.base_pipeline
----------------------------------------
...
from synclair_core.pipeline.base_module import AnalysisModule, ModuleConfigT
