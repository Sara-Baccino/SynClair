"""
synclair_core.pipeline.base_module
-------------------------------------

Defines the contract every SynClair analysis module implements. This is
...
from synclair_core.exceptions import NotFittedError
...
type (e.g. AnalysisModule[ClusteringConfig]), keeping synclair-core
unaware of any concrete module config."""


class AnalysisModule(ABC, Generic[ModuleConfigT]):
    """Abstract base class for every SynClair analysis module.
