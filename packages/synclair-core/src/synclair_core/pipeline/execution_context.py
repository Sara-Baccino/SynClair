"""
synclair_core.pipeline.execution_context
--------------------------------------------
...
from synclair_core.dataset.imputation import FittedImputers
from synclair_core.dataset.scaling import FittedScalers
from synclair_core.dataset.transformers import FittedEncoders
from synclair_core.exceptions import PipelineError
