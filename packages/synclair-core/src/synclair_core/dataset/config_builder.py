"""
synclair_core.dataset.config_builder
--------------------------------------
...
synclair-core where dataset inspection and configuration construction
...
from synclair_core.models.column_info import ColumnInfo, ColumnType
